...
include "../core/reclamationC.php";
        ...
        $listeReclamations=$reclamation1C->afficherReclamationsuser($_POST['utilisateur']);
?>
...
foreach($listeReclamations as $row){
    ...
    <td><a href="dashbordDetaille.php?emaill=<?PHP echo $row['email']; ?>" class="add-cart cart-check">Ouvrir</a></td>
    <td><a href="dashbordDetaille.php?emaill=<?PHP echo $row['email']; ?>" class="add-cart cart-check">Archiver</a></td>
    </tr>
    <?PHP
}
?>
