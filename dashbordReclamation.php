        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden" href="./"><img src="images/logoG.png" alt="Logo"></a>
...
foreach($listeReclamations as $row){
    ...
    <td><a href="dashbordSupp.php?emaill=<?PHP echo $row['email']; ?>" class="add-cart cart-check">Supprimer</a></td>
    </tr>
    <?PHP
}
?>
